...
class LuckyThree extends React.Component {
  ...
  tryLuckClickHandler (e) {
       return this.checkAllCards.bind(e)
    }
        ...
        return (
            <div className="main-container">
                <div className="number-cards-container">
                    ...
                    <NumberCard id={this.props.idArr[0]} color={this.props.colorsArr[0]} cardClickHandler={this.cardClickHandler(this.props.idArr[0])} />
                    <NumberCard id={this.props.idArr[1]} color={this.props.colorsArr[1]} cardClickHandler={this.cardClickHandler(this.props.idArr[1])}/>
                    <NumberCard id={this.props.idArr[2]} color={this.props.colorsArr[2]} cardClickHandler={this.cardClickHandler(this.props.idArr[2])}/>
                </div>
                {
