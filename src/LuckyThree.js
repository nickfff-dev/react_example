...
class LuckyThree extends React.Component {
    ...
    cardClickHandler (e) {
        this.displayRandomNumbers.bind(this, e)
    }
  ...
  tryLuckClickHandler (event) {
        this.checkAllCards.bind(this, event)
    }
    ...
    render() {
        return (
            <div className="main-container">
                ...
                <input id="tryYourLuckBtn" className="custom-btn" type="button" value="Try Your Luck" onClick={this.tryLuckClickHandler.bind(this)} />
            </div>
        )
    }
}
